      ...
      <div className='container'>
        <div className='row'>
          <div className='box col-12'>
            <img className='img thumbnail round left portrait' src='https://res.cloudinary.com/abhook/image/upload/v1496833315/10502077_10201515273042966_129626617606738027_n_p8bsw8.jpg' alt='profile image'/>
