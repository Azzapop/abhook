Post.create({
  ...
  content: "hiya! welcome to my blog. each month (timeframe not exact) i'll be posting up a topic that interests me. it may be related to software development, it may be talking about my plans for the future, it may be my personal opinion on current topics and trends. whatever it may be, i hope you find it entertaining / informative / useful / funny ...\ni'll be honest. there's nothing in this blog. it just felt so naked putting my first personal website up without a single post in the blog. i am currently working on a piece detailing my experiences working with the react on rails gem (which you can see here: github.com/shakacode/react_on_rails). check back within the month (tm) to see the piece."
})
